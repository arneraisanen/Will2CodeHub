...
<html lang="en"> 
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">Edit States</h2>
					...
					<div class="col-sm-6">
						<div class="email-form">
							...
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="registerBtn" type="button" onclick="edit_specialisation_show(3);">Edit</button>
									</li>
								</ul>
							</div>
							</label>
						...
						<div class="email-form" id="edit_field" style="display:none;min-width: 800px;">
							...
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="cancelBtn" type="button" onclick="edit_specialisation_hide(3);">Cancel</button>
									</li>
									<li>
										<button id="cancelBtn" type="button" onclick="edit_specialisation_delete(3);">Delete</button>
									</li>
									<li>
										<button id="registerBtn" type="button" onclick="edit_specialisation_save(3);">Save</button>
									</li>
								</ul>
							</div>
							</label>
						...
						<div class="email-form" id="edit_field" style="min-width: 800px;  margin-top: 50px;">
							...
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="registerBtn" type="button" onclick="add_specialisation_show(3);">Add new entry</button>
									</li>
								</ul>
							</div>
							</label>
						...
						<div class="email-form" id="add_field" style="display:none;min-width: 800px;">
							...
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="cancelBtn" type="button" onclick="add_specialisation_hide(3);">Cancel</button>
									</li>
									<li>
										<button id="registerBtn" type="button" onclick="add_specialisation_save(3);">Save</button>
									</li>
								</ul>
							</div>
							</label>
