...
ob_start();
include($doc_root."/business_logic/sales_tool/get_permit.php");
$permit_form = ob_get_contents();
ob_end_clean();
	...
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/sales_tool/insert_admin_menu.php"; ?>
        ...
        <div class="col-sm-12 main">
          ...
          <div style="float:left; margin-top: 10px; position:absolute;">
         		<img id="info_button" style="cursor: pointer;float: left;clear: both; margin-top: 50px;" src="/images/info.png" title="Click to Toggle Page Instructions" alt="Click to Toggle Page Instructions" /><br /><div id="info_div" style="display:none;z-index: 1000;width: 400px;margin: 10px 10px 60px;float: right;clear: both;border-radius: 10px;padding: 15px;color: #ddd;background-color: #5c9112;">If the company requires a permit(s), then set the radio button "Company to Pull Permit" to "Yes", then provide the necessary details and costs.<br /><br />Additionally please provide the Tax Exemption Number, if applicable, and the Sales Tax.<br /><br /><strong>Note:</strong> If the customer has any special requirements which employees or contractors need to be aware of, then please fill out the "Special Instructions" field.</div>
         	</div>
		...
		<section id="holder">
		    <h1 style="color:#404040;clear: both;" class="begining">Permits & Sales Tax</h1>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="email-form" id="add_field" style="min-width: 800px;">
								<div style="width:100%;">
									<?php echo $permit_form ?>
								</div>
								<label style="float: right;">
								<div class="cancel-submit" style="padding:0px; float:right;">
									<ul>
										<li>
											<button id="registerBtn" type="button" onclick="add_permit_save(1);">Save</button>
										</li>
									</ul>
								</div>
								</label>
		    ...
		    <p><a class="link" href="index5.php" data-color="#fff"><button onclick="play_sound(this)" style="width:150px;" type="button" class="btn btn-primary">Previous</button></a> | 
		    <a class="link" href="index7.php" data-color="#fff"><button onclick="play_sound(this)" style="width:150px;" type="button" class="btn btn-success">Next</button></a></p>
		    <br /><br />
