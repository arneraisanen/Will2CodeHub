...
$button_count= $_POST['button_count'];
...
try
{
	...
	$STH = $DBH->prepare("INSERT INTO demo_feature_csr_scripts_nextscript ( script_id, next_script_id, button_text ) values ( :script_id, :next_script_id, :button_text )");

	$STH->bindParam(':script_id', $script_id);
	$STH->bindParam(':next_script_id', $next_script_id);
	$STH->bindParam(':button_text', $button_text);
	$STH->execute();
