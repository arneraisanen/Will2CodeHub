...
$_SESSION['sub_project'] = $_GET['sub_project'];
$sub_project = $_GET['sub_project'];
...
try
{
	...
	$STH = $DBH->prepare("SELECT id, project_name, sub_project, script, next_script, first_script FROM demo_feature_csr_scripts WHERE project_name = '$project_name' AND sub_project = '$sub_project' AND first_script = '1'");
	$STH->execute();
