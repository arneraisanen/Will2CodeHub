...
$_SESSION['package_type'] = 'platinum';
...
ob_start();
include($doc_root.'/business_logic/admin/pdf_html_template_tmp.php');
...
$fill_color[] = hexdec(substr($company_color,0,2));
$fill_color[] = hexdec(substr($company_color,2,2));
$fill_color[] = hexdec(substr($company_color,4,2));
	...
	class MYPDF extends TCPDF {
	    ...
	    public function Header() {
	        ...
	        $this->Rect(0,0,210,297,'F','',$fill_color);
...
$user_filename = $doc_root.'/business_logic/sales_tool/autogenerated_pdfs/' . $_SESSION['package_type'] . '_order_pdf_' . $client_name1 . '_' . $client_id . '_' . $proposal_id . '.pdf';
$server_pdf_filename = '/business_logic/sales_tool/autogenerated_pdfs/' . $_SESSION['package_type'] . '_order_pdf_' . $client_name1 . '_' . $client_id . '_' . $proposal_id . '.pdf';
