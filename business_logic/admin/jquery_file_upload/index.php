...
<div class="container">
    ...
    <div style="margin-bottom: 30px;width: 50%;">
		...
		<select id="image_folder" name="specialisation" class="form-control" onchange="set_image_folder()">
		    <?php echo $doctor_specialisations ?>
		</select>
	</div>
	<div id="image_upload_form_section" style="display:block">
    ...
    <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
        ...
        <?php echo '<h3 style="margin:0px 0px 20px 0px;">Folder: ' . $custom_dir_var . '</h3>' ?>
        </tbody></table>
    </form>
    </div>
    <br>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul>
                ...
                <li>Only image files (<strong>JPG, GIF, PNG</strong>) are allowed (but all file types are supported)</li>
