...
ob_start();
include($doc_root."/business_logic/admin/get_companies_list_license.php");
...
<html lang="en"> 
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">Edit License</h2>
			...
			<form id="theform">
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="email-form" id="license_field" style="min-width: 800px;">
							<div id="license_field" style="width:100%;">
							</div>
						</div>
					</div>
				</div>
