...
$inputFileName = '../../../../../driver/driver_db_test.xls';
...
for ($startRow = 3; $startRow <= 5; $startRow += $chunkSize) {
	...
	foreach ($sheetData as $val) 
	{
		if ($val["A"] != NULL)
		{
			...
			echo $val["D"];
			echo $val["E"];	
			//echo 'NHRDA#: ' . $val["A"] . ' Firstname: ' . $val["B"] .  ' Surname: ' . $val["C"] . ' City: ' . $val["D"] . ' State: ' . $val["E"];
		}
	}
	echo '<br /><br />';
}
