...
{
	$tax_var = $sales_tax . '%';
	$sales_tax_var = '<tr style="background-color: #eee;"><td><b>Total Investment </b>(including sales tax @' . $sales_tax . '%)</td><td style="text-align:right;" colspan="2">' . $sales_tax_total . '</td></tr>';
}
else 
...
<tr><td></td><td></td><td></td></tr>
<tr style="background-color: #eee;"><td><b>Investment:</b></td><td style="text-align:right;" colspan="2">$proposal_cost</td></tr>
$sales_tax_var
</table>
