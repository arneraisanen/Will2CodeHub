...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../profile_images/',
            'upload_url' => $this->get_full_url().'/../../../profile_images/',
            'user_dirs' => true,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function trim_file_name($name, $type, $index, $content_range) {
        ...
        if (strpos($name, '.') === false &&
            ...
            $name = $_SESSION['id'] . '.jpg';// . $matches[1];
            //$name .= '.'.$matches[1];
        }
        return $name;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->name = $name = $_SESSION['id'] . '.jpg';
