...
ob_start();
include($doc_root."/business_logic/admin_tool/get_pdf_titles.php");
...
<html lang="en"> 
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin_tool/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">Edit PDF Titles</h2>
					...
					<div class="col-sm-6">
						...
						<div class="email-form" id="add_field" style="min-width: 800px;">
							...
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="registerBtn" type="button" onclick="add_pdf_titles(1);">Save</button>
									</li>
								</ul>
							</div>
							</label>
