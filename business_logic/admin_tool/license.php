...
ob_start();
include($doc_root."/business_logic/admin_tool/get_license.php");
$license = ob_get_contents();
ob_end_clean();
?>
<!DOCTYPE html>
<html lang="en"> 
  <head>
    ...
    <title>License Agreement with Arbco LLC</title>
  </head>
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin_tool/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">License Agreement With Arbco LLC</h2>
