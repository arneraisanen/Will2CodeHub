...
ob_start();
include($doc_root."/business_logic/admin_tool/get_company_matrix.php");
$company_matrix = ob_get_contents();
ob_end_clean();
?>
<!DOCTYPE html>
<html lang="en"> 
  <head>
    ...
    <title>Edit Company Matrix</title>
  </head>
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin_tool/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">Edit Company Matrix</h2>
					...
					<div class="col-sm-6">
						...
						<div class="email-form" id="add_field" style="min-width: 800px;">
							<div style="width:300px;">
								<?php echo $company_matrix ?>
							</div>
							<label>
							<div class="cancel-submit" style="padding:0px; float:right;">
								<ul>
									<li>
										<button id="registerBtn" type="button" onclick="add_company_matrix(1);">Save</button>
									</li>
								</ul>
							</div>
							</label>
