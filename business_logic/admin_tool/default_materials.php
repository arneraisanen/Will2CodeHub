...
ob_start();
include($doc_root."/business_logic/admin_tool/get_material_lists.php");
...
<html lang="en"> 
  <head>
    ...
    <title>Add/Edit Default Material Lists</title>
...
$(document).ready(
  ...
  <body>
	<?php include $_SERVER['DOCUMENT_ROOT']."/business_logic/admin/insert_admin_menu.php"; ?>
        ...
        <h2 class="sub-header">Add/Edit Default Material Lists</h2>
