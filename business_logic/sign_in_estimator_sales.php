...
<html lang="en">
  <head>
    ...
    <title>Sign into the Sales Backend</title>
  </head>
  ...
  <body>
    <div class="container marketing" style="clear:both;">
      ...
      <form action="process/sales_sign_in.php" method="post" enctype="multipart/form-data" class="form-signin" style="width: 300px; margin: 30px auto 150px;">
        <h2 class="form-signin-heading">Sales Tool: sign in</h2>
